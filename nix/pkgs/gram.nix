...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  postPatch = ''
    # The generate-licenses script wants a specific version of cargo-about even
    # though newer versions work just as well.
  ...
  env = {
    ...
    GRAM_UPDATE_EXPLANATION = "Updates are handled by this Nix configuration";
    GRAM_NO_BUNDLED_UNINSTALL = "Use Nix to uninstall Gram";
  };
  ...
  + lib.optionalString stdenv.hostPlatform.isDarwin ''
    ...
    pushd crates/gram
    # This is GNU sed, while Gram's bundle-mac script uses BSD sed.
    ...
    # The CLI uses its physical location to determine which app to start.
  ...
  passthru = {
    ...
    tests.remoteServerVersion = testers.testVersion {
